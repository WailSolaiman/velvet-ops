        ...
        <div className="bg-card flex flex-col justify-between rounded-xl border p-1 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row">
            <PricingCard
              ...
              description="مشاريع بحدود واضحة: اكتشاف، تصميم، وبناء واجهة—مناسبة لنسخة أولى، إعادة تصميم، أو سطح جديد."
              buttonVariant="outline"
              ctaLabel="ناقش sprint"
              features={[
            ...
            <PricingCard
              title="الدمج"
              price="اشتراك شهري"
              description="جزء مخصّص من التصميم والواجهة الأمامية كل شهر—دعم خارطة الطريق، التكرار، والتفكير في الأنظمة."
              ...
              features={[
                ...
                'طقوس عبر الفرق (مناسبة للعمل غير المتزامن)',
